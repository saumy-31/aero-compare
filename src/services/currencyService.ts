...
const REGION_CURRENCY_MAP: Record<string, string> = {
  IN: 'INR', US: 'USD', GB: 'GBP', UK: 'GBP', JP: 'JPY',
  AE: 'AED', CA: 'CAD', AU: 'AUD', NZ: 'NZD', SG: 'SGD',
  HK: 'HKD', TH: 'THB', CH: 'CHF', SE: 'SEK', NO: 'NOK',
  DK: 'DKK', ZA: 'ZAR', BR: 'BRL', MX: 'MXN',
  // Eurozone countries
...
const TIMEZONE_FALLBACK_MAP: Record<string, string> = {
  'Asia/Kolkata': 'INR', 'Asia/Calcutta': 'INR', 'Asia/Tokyo': 'JPY',
  'Asia/Dubai': 'AED', 'Europe/London': 'GBP', 'Europe/Paris': 'EUR',
  'Europe/Berlin': 'EUR', 'Europe/Rome': 'EUR', 'Europe/Madrid': 'EUR',
  'Europe/Amsterdam': 'EUR', 'America/New_York': 'USD',
  'America/Chicago': 'USD', 'America/Denver': 'USD',
  'America/Los_Angeles': 'USD', 'America/Toronto': 'CAD',
  'America/Vancouver': 'CAD', 'Australia/Sydney': 'AUD',
  'Australia/Melbourne': 'AUD', 'Asia/Singapore': 'SGD',
  'Asia/Hong_Kong': 'HKD', 'Asia/Bangkok': 'THB',
};
