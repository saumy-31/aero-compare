            ...
            {visibleDestinations.map((dest) => (
              ...
              >
                <div className="relative h-56 overflow-hidden flex-shrink-0 bg-gray-200 dark:bg-gray-800">
                  ...
                  {/* Dynamic Fallback handling to prevent any repeated images or borders */}
                  <img 
                    src={dest.image} 
                    alt={dest.city} 
                    loading="lazy"
                    onError={(e) => {
                      // Using picsum seeded by the destination ID guarantees a unique, 
                      // borderless 800x600 placeholder that will never repeat.
