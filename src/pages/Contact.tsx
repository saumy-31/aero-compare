...
export const Contact = () => {
  ...
  return (
    <>
      <SEO 
        title="Contact Us & Support | FlySava"
        description="Need help? Contact the FlySava support team or browse our frequently asked questions about flight comparisons, bookings, and platform usage."
